...
export const ITEM_WITH_CHATBOX_MESSAGES = {
  ...
  memberships: [
    {
      itemPath: 'adf09f5a-5688-11eb-ae93-0242ac130004',
...
export const ITEM_WITH_CHATBOX_MESSAGES_AND_ADMIN = {
  ...DEFAULT_FOLDER_ITEM,
  ...
  memberships: [
    {
      itemPath: '78ad1166-3862-4593-a10c-d380e7b66674',
  ...
  chat: [
    {
      body: 'message1',
      chatId: '78ad1166-3862-4593-a10c-d380e7b66674',
      createdAt: '2021-08-11T12:56:36.834Z',
      creator: CURRENT_USER.id,
    },
    {
