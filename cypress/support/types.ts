import { Category, ChatMention, ChatMessage, Invitation, Item, ItemCategory, ItemLoginSchema, ItemMembership, ItemPublished, ItemTag, ItemValidationGroup, LocalFileItemType, Member, S3FileItemType } from "@graasp/sdk";

// TODO: not the best way, to change with mirage?
export type ItemForTest = Item & {
  categories?: ItemCategory[], thumbnails?: string, tags?: ItemTag[]; itemLoginSchema?: ItemLoginSchema; readFilepath?: string; chat?: ChatMessage[], memberships?: ItemMembership[];
...
export type LocalFileItemForTest = (LocalFileItemType) & { createFilepath: string, readFilepath: string }
export type S3FileItemForTest = (S3FileItemType) & { createFilepath: string, readFilepath: string }
