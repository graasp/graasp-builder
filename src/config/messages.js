...
export const MOVE_ITEMS_ERROR_MESSAGE = 'There was an error moving the items.';
...
export const POST_ITEM_FLAG_ERROR_MESSAGE =
  'There was an error flagging the item';
